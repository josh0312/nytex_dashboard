"""Create items view with proper permissions

Revision ID: ca4bae3faf94
Revises: ca4bae3faf93
Create Date: 2025-06-18 14:15:00.000000
...
revision = 'ca4bae3faf94'
down_revision = 'ca4bae3faf93'  # Previous migration
branch_labels = None
depends_on = None


def upgrade():
    """Create the items_view for simplified data access with proper permissions"""
    ...
    # Grant permissions to the Cloud Run application user
