...
SELECT 
    ...
    -- Cost information - use square_item_library_export only (catalog_variations may not have default_unit_cost)
...
-- since not all environments have the default_unit_cost column in catalog_variations.
